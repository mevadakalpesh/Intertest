...
var user_delete_url = '<?php echo e(route("user.destroy","DUMMY")); ?>';
...
var user_id = $(this).attr('data-user_id');
var user_get_url = '<?php echo e(route("user.edit","DUMMY")); ?>';
...
var user_update_url = '<?php echo e(route("user.update","DUMMY")); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/data/com.termux/files/home/intpro/resources/views/user/user-listing.blade.php ENDPATH**/ ?>