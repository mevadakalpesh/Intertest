...
<input type="text" name="price" class="form-control" id="edit_price" placeholder="Price" min="1" />
 ...
 <div class="form-group mt-2">
        <label for="price">Description</label>
        <textarea name="description" id="edit_description" class="form-control" cols="30" rows="10"></textarea>
      </div>

<div class="form-group mt-2">
<label for="discount">Discount</label>
<input type="text" name="discount" class="form-control" id="edit_discount"
placeholder="Discount" />
</div>
...
product_get_url = product_get_url.replace('/DUMMY',
'/' + product_id);
...
$('#edit_product_body #edit_category').val(data.result.category_id);
$('#edit_product_body #edit_discount').val(data.result.discount);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /data/data/com.termux/files/home/intpro/resources/views/products/product-listing.blade.php ENDPATH**/ ?>